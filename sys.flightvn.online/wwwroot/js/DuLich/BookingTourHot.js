...
function chuyenBooking() {
    ...
    $.ajax({
        type: "POST",
        url: "../TourHot/ChuyenBookingTourHot",
        data: {
            TourCode: TourCode,
            NguoiNhan: NguoiNhan
        },
...
function sendDataBtn() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                type: "POST",
                url: "../TourHot/GuimailbookingTourHot",
                data: {
                    TourCode: TourCode,                 
                },
                success: function (response) {
...
function changeStatus() {
    Swal.fire({
        ...
        $.ajax({
            type: "POST",
            url: "../TourHot/ChangeBookingStatusTourHot",
            data: {
                IDStatus: IDStatus,
                TourCode: TourCode
            },
...
// Function to show the modal first, then show the confirmation
...
// Function to save the cancellation reason and show confirmation
function saveCancellationReason() {
    ...
    // Show confirmation dialog after reason is entered
    Swal.fire({
        title: 'Xác nhận thao tác',
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                type: "POST",
                url: "../TourHot/CancelBookingTourHot",
                data: {
