...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    function isClipPathChanged(clipPaths, prManagerlipPaths) {
	        if (!clipPaths || !prManagerlipPaths || (clipPaths.length !== prManagerlipPaths.length)) {
	            return true;
	        }
	        for (var i = 0; i < clipPaths.length; i++) {
	            if (clipPaths[i] !== prManagerlipPaths[i]) {
	                return true;
	            }
	        }
	    }
	...
	'use strict';
	    ...
	    module.exports = ChartView.extend({
	        ...
	        render: function (seriesModel, ecModel, api) {
	            ...
	            var prManageroordSys = this._coordSys;
	            ...
	            if (
	                !(polyline && prManageroordSys.type === coordSys.type)
	            ) {
