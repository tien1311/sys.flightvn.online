        ...
        public List<LichLamViecModel> LichLamViec()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    NV.FileHwa = "http://daily.airline24h.com/upload/ChamCong/" + dt.Rows[i]["FileHwa"].ToString();
                    NV.FileNgay1 = "http://daily.airline24h.com/upload/ChamCong/" + dt.Rows[i]["FileNgay1"].ToString();
                    NV.FileNgay2 = "http://daily.airline24h.com/upload/ChamCong/" + dt.Rows[i]["FileNgay2"].ToString();
                    NV.FileNgay3 = "http://daily.airline24h.com/upload/ChamCong/" + dt.Rows[i]["FileNgay3"].ToString();
                    NV.FileNgay4 = "http://daily.airline24h.com/upload/ChamCong/" + dt.Rows[i]["FileNgay4"].ToString();
                    NV.FileNgay5 = "http://daily.airline24h.com/upload/ChamCong/" + dt.Rows[i]["FileNgay5"].ToString();
                    NV.ThuHwa = ThuHwa;
